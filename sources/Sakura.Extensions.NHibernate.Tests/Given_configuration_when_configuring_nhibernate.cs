namespace Sakura.Extensions.NHibernate.Tests
{
    ...
    public class Given_configuration_when_started : WithSubject<Setup>
    {
        ...
        private It should_configure_session_factory = () =>
            {
        ...
        private It should_register_session_as_current_lifetime_scope= () =>
            {
                var registration =
        ...
        private It should_register_session_factory = () =>
            {
                var registration =
                    container.ComponentRegistry.RegistrationsFor(new TypedService(typeof(ISessionFactory))).
                        SingleOrDefault();
