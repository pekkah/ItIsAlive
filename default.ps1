...
Task PackAll -Depends BuildSolution {
	...
	Pack "$pack_dir\Sakura.Extensions.WebApi\Sakura.Extensions.WebApi-Template.nuspec" "$build_artifacts_bin_dir\Sakura.Extensions.WebApi.dll" $build_artifacts_dir
